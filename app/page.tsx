    ...
    <>
      ...
      <main className="flex flex-col">
        ...
        <section className="flex flex-col items-center text-center px-4 sm:px-6 relative pt-16 sm:pt-24 pb-6 gap-3 sm:gap-5">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_#5b9bd515_0%,_transparent_70%)] pointer-events-none" />
          ...
          <div className="flex gap-2 sm:gap-3 flex-wrap justify-center">
            <Link href="/about" className="px-7 sm:px-9 py-3 sm:py-3.5 rounded-full bg-[#5b9bd5] text-black font-bold text-sm sm:text-base hover:bg-[#e8c96a] transition-colors text-center">
              Tentang Kami
            </Link>
            <Link href="/members" className="px-7 sm:px-9 py-3 sm:py-3.5 rounded-full gold-border text-[#5b9bd5] font-bold text-sm sm:text-base hover:bg-[#5b9bd511] transition-colors">
              30+ Members →
            </Link>
          </div>
        </section>
        ...
        <div className="flex flex-col items-center gap-3 sm:gap-4 px-4 sm:px-6 pb-10 sm:pb-14">
          ...
          <div className="w-full max-w-sm sm:max-w-md">
            ...
            <div className="relative rounded-2xl border border-[#5b9bd533] bg-[#0d0d0d88] backdrop-blur-sm px-8 sm:px-14 py-4 sm:py-6 flex items-center justify-center gap-8 sm:gap-14">
              <div className="absolute inset-0 rounded-2xl bg-[radial-gradient(ellipse_at_center,_#5b9bd50a_0%,_transparent_70%)] pointer-events-none" />
              ...
              <a href="https://www.instagram.com/insiemeayodance.club" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 group/logo">
                <div className="relative w-20 h-20 sm:w-28 sm:h-28 rounded-full bg-[#111] border-2 border-[#5b9bd588] overflow-hidden
                  shadow-[0_0_24px_#5b9bd555,0_0_48px_#5b9bd522]
                  group-hover/logo:shadow-[0_0_32px_#5b9bd588,0_0_64px_#5b9bd544]
                ...
                <p className="text-[#5b9bd5] text-[10px] sm:text-xs font-semibold tracking-widest uppercase group-hover/logo:underline">INSIEME</p>
              </a>

              <div className="flex flex-col items-center gap-1">
                <div className="w-px h-6 bg-gradient-to-b from-transparent via-[#5b9bd566] to-transparent" />
                <span className="text-[#5b9bd5] text-xl sm:text-3xl font-light">×</span>
                <div className="w-px h-6 bg-gradient-to-b from-transparent via-[#5b9bd566] to-transparent" />
              </div>
              ...
              <a href="https://www.instagram.com/me.bebyfie" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 group/logo2">
                <div className="relative w-20 h-20 sm:w-28 sm:h-28 rounded-full bg-[#111] border-2 border-[#5b9bd588] overflow-hidden
                  shadow-[0_0_24px_#5b9bd555,0_0_48px_#5b9bd522]
                  group-hover/logo2:shadow-[0_0_32px_#5b9bd588,0_0_64px_#5b9bd544]
                ...
                <p className="text-[#5b9bd5] text-[10px] sm:text-xs font-semibold tracking-widest group-hover/logo2:underline">MeantToBe</p>
              </a>
            </div>
          </div>

          {/* Find Us Here */}
          <div className="w-full border-t border-[#5b9bd522] pt-3 sm:pt-4 text-center">
